                ...
                <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                    ...
                    <div className="mt-8 sm:flex sm:items-center sm:justify-between">
                        <div className="block sm:hidden">
                            <button className="flex cursor-pointer items-center gap-2 border-b border-gray-400 pb-1 text-gray-900 transition hover:border-gray-600">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-4 w-4 rtl:rotate-180">
                    ...
                    <ul className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">

                        {
                            listProduct.map(i => {
                                return <li key={i.id}>
                                    <Link to={`/product/${i.id}`} className="group block overflow-hidden">
                                        <img src={i?.image} alt="" className="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]" />
                                        <div className="relative bg-white pt-3">
                                            ...
                                            <p className="mt-2">
                                                ...
                                                <span className="text-xl mb-2 font-bold">{i?.name}</span>
                                                <span className="tracking-wider text-gray-900"> ${i?.price} </span>
                                            </p>
                                        </div>
                                    </Link>
                                </li>
