        ...
        <div className="border-r-2 w-[20%] h-full flex flex-col justify-between">
            <div className="px-4 py-6">
                ...
                <ul className="mt-6 space-y-1">
                    ...
                    <li>
                        <Link to="/admin/product/category" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                            Category
                        </Link>
                    </li>
                    <li>
                        <Link to="/admin/users" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                            Users
                        </Link>
                    </li>
                    <li>
